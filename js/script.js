...
let arrayTextxsFr = [
  ...
  { title: "Copier HD" },
  {title: "Format Station - Marcus Winckler"},
...
let arrayTextxsGe= [
  { title: "კალიბრაცია" },
  { title: "დენი შელბი" },
  {title: "პოსტპროდაქშენი" },
  { title: "პოსტპროდაქშენი კიოლნი" },
  {title: "მარკ შუბერტ"},
  { title: "მაქსიმილიან დედერიხსი" },
  { title: "Jan Wilm Schmülling" },
  { title: "გადამწერი HD" },
  {title: "ფორმატის სადგური - მარკუს ვინკლერი"},
  { title: "ფაბრიკაცია DCP" },
  { title: "ფერის კულტი – ერჰარდ გიზენი" },
  { title: "მუსიკა" },
